...
function Hero() {
  ...
  return (
    ...
    >
      <div className="absolute rounded-full brightness-120 -left-5 -top-2 lg:left-12 lg:top-6 bg-primary h-70 w-50 lg:h-100 lg:w-120 -z-1"></div>
      <div className="absolute right-0 rounded-full bg-primary bottom-10 size-60 lg:size-100 -z-1"></div>
      <div className="absolute left-0 rounded-full bg-primary top-20 size-30 lg:size-60 -z-1"></div>
      <div className="absolute rounded-full rigth-0 bg-chart-2 -bottom-20 size-40 lg:size-60 -z-1"></div>

      {/* grainy noise */}
      <span className="absolute z-11 opacity-25 mix-blend-overlay size-full bg-[url('./assets/noise.svg')]"></span>
      {/* overlay blur */}
      ...
      <AnimatePresence>
        ...
        >
          <div className="space-y-2">
            <h1 className="text-5xl font-extrabold tracking-tighter text-center selection:bg-primary md:font-bold lg:text-[100px] scroll-m-20 text-balance">
              {t('hero.title')}
            </h1>
            <Paragraphe className="font-medium text-center text-foreground/90">
              {t('hero.subtitle')}
            </Paragraphe>
          </div>
